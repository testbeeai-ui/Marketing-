...
export const CreateBlockDialog = ({
  isOpen,
  onClose,
  onCreate,
  isCreating = false,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // onCreate triggers the mutation, which will handle success/error
    // The isSubmitting state is controlled by the parent via isCreating prop
